    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="register-card card p-5 w-100" style="max-width: 420px;">
            ...
            <form id="registerForm" novalidate action="" method="post">
                ...
                <div class="mb-3">
                    <label for="registerEmailAddress" class="form-label">Email</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-envelope-at"></i></span>
                        <input type="email" class="form-control" id="registerEmailAddress" placeholder="Enter email" name="email" required>
